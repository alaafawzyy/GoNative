...
public class MainActivity extends AppCompatActivity implements Observer,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            // Initialize AdMob
            Log.d(TAG, "Before initializing AdMob");
    ...
    private boolean isLightMode(String theme) {
    ...
    public void updateStatusBarStyle(String statusBarStyle) {
        if (!TextUtils.isEmpty(statusBarStyle)) {
            ...
            controllerCompat.setAppearanceLightStatusBars(isLightMode(statusBarStyle));
        }
    }
    ...
    public void updateSystemNavBarStyle(String systemNavBarStyle) {
        if (!TextUtils.isEmpty(systemNavBarStyle)) {
            WindowInsetsControllerCompat controllerCompat = WindowCompat.getInsetsController(getWindow(), getWindow().getDecorView());
            controllerCompat.setAppearanceLightNavigationBars(isLightMode(systemNavBarStyle));
        }
    }
